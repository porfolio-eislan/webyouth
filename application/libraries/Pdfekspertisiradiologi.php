...
class Pdfekspertisiradiologi extends FPDF
{
  var $widths;
  var $heights;
  var $aligns;
  ...
  // {
  //   //Put the watermark
  //   $image = FCPATH . '/assets/images/icon/simrs-watermark-laporan.png';
  //   //
  //   if ($image != '') {
  ...
  function imageUniformToFill($imgPath, $x = 0, $y = 0, $containerWidth = 210, $containerHeight = 297, $alignment = 'C')
  {
  ...
  // function Footer()
  // {
  //   $main = @$GLOBALS['get_main'];
  //   $tgl_hasil = @$GLOBALS['tgl_hasil'];

  //   if (@$main['periksa_st'] == '1') {
  //     if (ifCountDateTwoDate(@$tgl_hasil['tgl_hasil'], @$main['tgl_order']) == '2') {
  //       $waktuLayan = time_elapsed_two_date(@$tgl_hasil['tgl_hasil'], @$main['tgl_order'], false);
  //     } else {
  //       $waktuLayan = time_elapsed_two_date(@$tgl_hasil['tgl_hasil'], @$main['tgl_order'], false);
  //     }
  //   } else {
  ...
  //   if (@$tgl_hasil['tgl_hasil'] != '') {
  //     $tglHasil = to_date(@$tgl_hasil['tgl_hasil'], '', 'full_date');
  //   } else {
  //     $tglHasil = '-';
  //   }
  ...
  //   $this->Cell(0, 10,  @$tglHasil . '                ' . @$waktuLayan, 0, 0, 'L');
  // }
