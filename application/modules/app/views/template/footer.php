                                        ...
                                        <div class="row g-3">
                                            <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-1.jpg" class="img-fluid w-100" alt="">
                                           ...
                                           <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-2.jpg" class="img-fluid w-100" alt="">
                                                    <div class="footer-search-icon">
                                            ...
                                            <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-3.jpg" class="img-fluid w-100" alt="">
                                                    <div class="footer-search-icon">
                                            ...
                                            <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-4.jpg" class="img-fluid w-100" alt="">
                                                    <div class="footer-search-icon">
                                            ...
                                            <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-5.jpg" class="img-fluid w-100" alt="">
                                                    <div class="footer-search-icon">
                                           ...
                                           <div class="col-4">
                                                <div class="footer-instagram rounded">
                                                    <img src="<?= base_url() ?>assets/img/instagram-footer-6.jpg" class="img-fluid w-100" alt="">
                                                    <div class="footer-search-icon">
